            ...
            <div className="qualification__container container">
                ...
                <div className="qualification__sections">
                    ...
                    >
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">GCE O' Level</h3>
                                <span className="qualification__subtitle">
                                    NVSS
                                </span>
                                <div className="qualification__calender">
                    ...
                    <div className={
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">National Youth Council</h3>
                                <span className="qualification__subtitle">
                                    RPA Developer
                                </span>
                                <div className="qualification__calender">
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">Accenture</h3>
                                <span className="qualification__subtitle">
                                    Treasury Intern
                                </span>
                                <div className="qualification__calender">
